<?php
    ...
    $app->get("/", function(){
        ...
        $third_cd = new CD("I don't get it", "Pork Lion", "images/porklion.jpg", 5000.01);
        $fourth_cd = new CD("Nevermind", "Nirvana", "images/nevermind.jpg", 10.50);
        ...
        foreach ($cds as $album) {
            $output = $output . "<div class='row'>
                <div class='col-md-6'>
                    <img src=" . $album->getCoverArt() . " alt='really'>
                </div>
                <div class='col-md-6'>
                    <p>" . $album->getTitle() . "</p>
